        ...
        var _ = function() {
          ...
          se = function(e) {
            ...
            return (
              ...
              f.cookie("webVideoCtrlProxy", RegExp.$2, { raw: !0 }),
              e
            );
          },
          oe = function() {
          ...
          (this.I_ReversePlayback = function(e, t) {
            ...
            if ((f.extend(P, t), -1 != r)) {
              ...
              if (
                ...
                return _("获取端口号失败"), s;
              f.extend(P, { urlProtocol: i, cgi: o, iPort: a, iChannelID: c }),
                (r = this.findWndIndexByIndex(P.iWndIndex)),
                -1 == r &&
                  ((P.szStartTime =
                    P.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z"),
            ...
            "" == t || B(t)
              ...
              : ((r = parseInt(t.substring(0, 3))),
                ...
                isNaN(r)
                  ? e.funErrorCallback()
                  : y == r
                  ? e.funSuccessCallback(f.loadXML(n))
                  : e.funErrorCallback(r, f.loadXML(n)));
          });
        var le = function() {};
        (le.prototype.CGI = {
          ...
          (le.prototype.startRealPlay = function(e, t) {
            ...
            if (re()) {
              var a = new Promise(function(n, s) {
                c.JS_Play(r, { session: e.szAuth }, t.iWndIndex).then(
                  function() {
                    i(), n();
                  },
                  function() {
          ...
          (le.prototype.startPlayback = function(e, t) {
            ...
            if (re()) {
              var l = new Promise(function(t, i) {
                c.JS_Play(r, { session: e.szAuth }, n, s, o).then(
                  function() {
                    u(), t();
                  },
                  function() {
